...
var uploadTools = {
    ...
    "initWithUpload": function(opt) {
        ...
        if (!opt.isHiddenUploadBt) {
            ...
            $("#" + uploadId + " .uploadBts .uploadFileBt i").css("color", "rgb(85, 85, 85)");
        }
    ...
    "initWithCleanFile": function(opt) {
        ...
        if (!opt.isHiddenCleanBt) {
            ...
            $("#" + uploadId + " .uploadBts .cleanFileBt i").css("color", "rgb(85, 85, 85)");
        }
    },
    /**
     * 初始化选择文件按钮
    ...
    "initWithLayout": function(opt) {
        ...
        btsStr += "<div>";
        btsStr += `<div class="selectFileBt"><i class="fas fa-plus"></i></div>`;
        btsStr += "</div>";
        //上传按钮
        if (!opt.isHiddenUploadBt) {
    ...
    "uploadError": function(opt) {
        ...
        $("#" + uploadId + " .2 .fileItem .status>i").addClass("iconfont icon-cha");
